...
git clone https://github.com/azerothcore/mod-account-mounts.git "$server/modules/mod-account-mounts"
git -C "$server/modules/mod-account-mounts" checkout "$ACCOUNT_MOUNTS_REF"
git -C "$server/modules/mod-account-mounts" apply "$root/patches/mod-account-mounts-safety.patch"
...
git clone https://github.com/azerothcore/mod-1v1-arena.git "$server/modules/mod-1v1-arena"
git -C "$server/modules/mod-1v1-arena" checkout "$ARENA_1V1_REF"
